...
struct EditTransactionView: View {
    ...
    init(direction: Direction, transaction: Transaction? = nil, modelContainer: ModelContainer) {
        ...
        _viewModel = StateObject(wrappedValue: EditTransactionViewModel(direction: direction, transaction: transaction, modelContainer: modelContainer))
        if let transaction {
...
struct CategoryPickerView: View {
    ...
    init(direction: Direction, selectedCategory: Binding<Category>, modelContainer: ModelContainer) {
        self.direction = direction
        self.modelContainer = modelContainer
        self._selectedCategory = selectedCategory
        self._viewModel = StateObject(wrappedValue: CategoryPickerViewModel(direction: direction, modelContainer: modelContainer))
    }
